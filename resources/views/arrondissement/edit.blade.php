                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="breadcrumb ml-2">
                                        <li class="breadcrumb-item"><a href="{{ route('arrondissement') }}">Arrondissement</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST"
                                        action="{{ route('arrondissement.edit.post', ['id' => $arrondissement->id]) }}">
                                        @csrf
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input value="{{ $arrondissement->description }}" class="form-control" id="description" name="description"
                                                    required>
                                                ...
                                                <select data-live-search="true" name="department_id" class="selectpicker w-100"
                                                    ...
                                                    @foreach ($department as $item)
                                                        <option value="{{ $item->id  }}"
                                                            {{ $item->id ===  $arrondissement->department_id ? 'selected' : '' }} >
