                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <p class="account-subtitle">
                                @if (session('status'))
                            <div class="alert alert-success" role="alert"> Nous avons envoyé votre lien de réinitialisation de mot de passe par e-mail!
                                {{ session('status') }}
                            </div>
                            @endif
                            </p>
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">{{ __('Addresse Couriel') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">{{ __('Confirm Mot de Passe') }}</label>
