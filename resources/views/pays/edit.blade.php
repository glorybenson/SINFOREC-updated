                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="breadcrumb ml-2">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Pays</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('pays.edit.post', ['id' => $pay->get('id')]) }}">
                                        @csrf
                                        {{-- <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" id="description" value="{{ $pay->get('description') }}" name="description" required>
