                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div>
                                        <h5 class="text-left" class="btn btn-primary ml-2 p-2 pr-3 pl-3 pull-left">{{ $values->{'groom-first_name'} }} {{ $values->{'groom-family_name'} }}</h5>
                                        <h5 class="text-left" class="btn btn-primary ml-2 p-2 pr-3 pl-3 pull-left">{{ $values->{'bride-first_name'} }} {{ $values->{'bride-family_name'} }}</h5>
